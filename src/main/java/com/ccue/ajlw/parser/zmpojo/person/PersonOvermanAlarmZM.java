 ...
 *
 */
public class PersonOvermanAlarmZM implements Serializable {
	 ...
	 * 定员数
	 */	
	private  String personLimintNum;
	...
	public String getPersonLimintNum() {
		return personLimintNum;
	}

	public void setPersonLimintNum(String personLimintNum) {
		this.personLimintNum = personLimintNum;
	}
	...
	public void setPersonTotalNum(String personTotalNum) {
		this.personTotalNum = personTotalNum;
	}
