 ...
 *
 */
public class PersonCallAlarmZM implements Serializable {
	...
	public String getEnterMineTime() {
		return enterMineTime;
	}

	public void setEnterMineTime(String enterMineTime) {
